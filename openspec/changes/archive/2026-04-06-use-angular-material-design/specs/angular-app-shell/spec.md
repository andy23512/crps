...
The system SHALL provide an Angular application shell that bootstraps successfully in a modern browser and renders the root game experience container using Angular Material layout and surface primitives.
...
The system SHALL expose layout regions for move controls, round result, and score display within Angular-managed templates, with consistent Angular Material spacing and visual hierarchy.
