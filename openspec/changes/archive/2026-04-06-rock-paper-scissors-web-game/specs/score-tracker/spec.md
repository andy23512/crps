...
The system SHALL maintain a cumulative count of player wins, computer wins, and draws for the duration of the browser session. Scores SHALL start at zero and increment after each completed round.
